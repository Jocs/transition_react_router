...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = (function (_Component3) {
		...
		function Form(props) {
			...
			var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(Form).call(this, props));
		...
		_createClass(Form, [{
			...
			value: function handleSubmit(event) {
				...
				this.setState({
					...
					return _this4.context.router.push('/');
				});
			}
		}, {
			key: 'handleChange',
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement('input', { type: 'text', onChange: this.handleChange.bind(this), value: this.state.inputText }),
					_react2.default.createElement(
						'button',
						{ type: 'submit' },
						'Submit'
